...
#VID2015 class dict
class_dict = {
'n02691156': 1, 'n02419796': 2,'n02131653': 3,'n02834778': 4,'n01503061': 5,
'n02924116': 6,'n02958343': 7,'n02402425': 8,'n02084071': 9,'n02121808': 10,
'n02503517': 11,'n02118333': 12,'n02510455': 13,'n02342885': 14,'n02374451': 15,
'n02129165': 16,'n01674464': 17,'n02484322': 18,'n03790512': 19,'n02324045': 20,
'n02509815': 21,'n02411705': 22,'n01726692': 23,'n02355227': 24,'n02129604': 25,
'n04468005': 26,'n01662784': 27,'n04530566': 28,'n02062744': 29,'n02391049': 30
}
...
flags = tf.app.flags
flags.DEFINE_string('root_dir', '/media/leen/Acer_500GB_HDD/Imagenet_VID_dataset/ILSVRC', 'Root directory to raw VID 2015 dataset.')
flags.DEFINE_string('set', 'train', 'Convert training set, validation set.')
flags.DEFINE_string('output_path', 'Data/VID', 'Path to output TFRecord')
...
def dicts_to_tf_example(dicts, root_dir, _set):
	...
	# Get image paths
	imgs_dir = os.path.join(root_dir, 'Data/VID/{}'.format(_set), folder)
