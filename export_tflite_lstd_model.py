...
flags.DEFINE_string('resolution', None, 'Resolution of the images used to train the model.')
FLAGS = flags.FLAGS
...
def main(_):
  ...
  flags.mark_flag_as_required('resolution')
  ...
  input_shapes = {
      'input_video_tensor': [lstm_config.eval_unroll_length, FLAGS.resolution, FLAGS.resolution, 3],
  }
  ...
  ofilename = os.path.join(FLAGS.export_path, 'model.tflite')
