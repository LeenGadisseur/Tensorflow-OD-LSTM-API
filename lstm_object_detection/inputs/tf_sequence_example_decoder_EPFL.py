...
class TFSequenceExampleDecoder(data_decoder.DataDecoder):
  ...
  def __init__(self):
    ...
    self.keys_to_features = {
        ...
        'region/label/index': tf.VarLenFeature(dtype=tf.int64),
        'region/label/string': tf.VarLenFeature(tf.string),
    ...
    self.items_to_handlers = {
        ...
        fields.InputDataFields.groundtruth_boxes:
            BoundingBoxSequence(prefix='region/bbox/'),
        fields.InputDataFields.groundtruth_classes: (
            tfexample_decoder.Tensor('region/label/index')),
