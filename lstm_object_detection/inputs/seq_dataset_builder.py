...
# LEEN aanpassing naar EPFL versie
from lstm_object_detection.inputs import tf_sequence_example_decoder_EPFL
...
def build(input_reader_config,
  ...
  # LEEN: aangepast naar EPFL versie
  decoder = tf_sequence_example_decoder_EPFL.TFSequenceExampleDecoder()
